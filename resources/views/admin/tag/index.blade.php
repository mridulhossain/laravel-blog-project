                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                           ...
                           @foreach ($tags as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.tag.edit',$value->id)}}" class="btn btn-info waves-effect">
                                            <i class="material-icons">edit</i>
                                        </a>
                                       <button type="button" class="btn btn-danger" onclick="deleteTag({{$value->id}})"><i class="material-icons">delete</i></button>
                                        <form id="delete-form-{{$value->id}}" action="{{route('admin.tag.destroy',$value->id)}}" method="POST" style="display: none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
