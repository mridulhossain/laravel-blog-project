...
<aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{Auth::user()->role->id ==1 ?route('admin.setting'):route('author.setting')}}"><i class="material-icons">person</i>Settings</a></li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">Mridul Hossain</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
